...
<head>
  <meta charset="utf-8" />
  <title>Firebase Notification | PHP-Mysql Backend</title>
            ...
            <div class="dropdown wrapper">
              <a href="app.page.profile">
                <span class="thumb-lg w-auto-folded avatar m-t-sm">
                  <img  src="assets/img/a0.jpg" class="img-full" alt="...">
                </span>
              </a>
            ...
            <ul class="list-group list-group-lg m-b-none">
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img  src="assets/img/a1.jpg" class="r r-2x">
                </a>
              ...
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img  src="assets/img/a2.jpg" class="r r-2x">
                </a>
              ...
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img  src="assets/img/a3.jpg" class="r r-2x">
                </a>
              ...
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img  src="assets/img/a4.jpg" class="r r-2x">
                </a>
                <span class="pull-right label bg-warning inline m-t-sm">Editor</span>
          ...
          <ul class="list-group no-bg no-borders pull-in">
            <li class="list-group-item">
              <a herf class="pull-left thumb-sm avatar m-r">
                <img  src="assets/img/a4.jpg" alt="..." class="img-circle">
            ...
            <li class="list-group-item">
              <a herf class="pull-left thumb-sm avatar m-r">
                <img  src="assets/img/a5.jpg" alt="..." class="img-circle">
                <i class="on b-white bottom"></i>
              </a>
              <div class="clear">
            ...
            <li class="list-group-item">
              <a herf class="pull-left thumb-sm avatar m-r">
                <img  src="assets/img/a6.jpg" alt="..." class="img-circle">
            ...
            <li class="list-group-item">
              <a herf class="pull-left thumb-sm avatar m-r">
                <img  src="assets/img/a7.jpg" alt="..." class="img-circle">
            ...
            <li class="list-group-item">
              <a herf class="pull-left thumb-sm avatar m-r">
                <img  src="assets/img/a8.jpg" alt="..." class="img-circle">
                <i class="away b-white bottom"></i>
              </a>
              <div class="clear">
      ...
      <div role="tabpanel" class="tab-pane tab-2" id="tab-2">
        <div class="wrapper-md">
          ...
          <ul class="list-group no-borders pull-in auto">
            <li class="list-group-item">
              <span class="pull-left thumb-sm m-r"><img  src="assets/img/a1.jpg" alt="..." class="img-circle"></span>
            ...
            <li class="list-group-item">
              <span class="pull-left thumb-sm m-r"><img  src="assets/img/a2.jpg" alt="..." class="img-circle"></span>
              <a href="#" class="text-muted" ui-toggle-class="show" target=".app-aside-right"><i class="fa fa-comment-o pull-right m-t-sm text-sm"></i></a>
              <div class="clear">
            ...
            <li class="list-group-item">
              <span class="pull-left thumb-sm m-r"><img  src="assets/img/a3.jpg" alt="..." class="img-circle"></span>
              <a href class="text-muted" ui-toggle-class="show" target=".app-aside-right"><i class="fa fa-comment-o pull-right m-t-sm text-sm"></i></a>
              <div class="clear">
            ...
            <li class="list-group-item">
              <span class="pull-left thumb-sm m-r"><img  src="assets/img/a4.jpg" alt="..." class="img-circle"></span>
              <a href class="text-muted" ui-toggle-class="show" target=".app-aside-right"><i class="fa fa-comment-o pull-right m-t-sm text-sm"></i></a>
              <div class="clear">
      ...
      <div class="row-row">
        <div class="cell">
          <div class="cell-inner padder">
            <!-- chat list -->
            <div class="m-b">
              <a href class="pull-left thumb-xs avatar"><img  src="assets/img/a2.jpg" alt="..."></a>
              <div class="clear">
            ...
            <div class="m-b">
              <a href class="pull-right thumb-xs avatar"><img  src="assets/img/a3.jpg" class="img-circle" alt="..."></a>
              <div class="clear">
